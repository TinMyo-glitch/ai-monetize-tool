...
# Page Config
st.set_page_config(page_title="AI Ultra Recap Tool", layout="centered")

st.title("🛡️ AI Ultra Recap - Monetization Pro")

with st.sidebar:
    st.header("Effect Settings")
...
def process_advanced_video(video_path, bgm_path, output_path):
    ...
    # --- အရေးကြီးဆုံးအပိုင်း: Width နဲ့ Height ကို စုံကိန်းဖြစ်အောင် ပြင်ခြင်း ---
    ...
    # Windows Compatibility Output Settings
...
if uploaded_video is not None:
    if st.button("Generate Ultra Copyright-Free Video", type="primary"):
        with st.spinner("Video Size ညှိနှိုင်းပြီး ထုတ်ပေးနေပါသည်..."):
